...
import net.sf.login.remote.LoginWorldInterface;
...
import net.sf.world.remote.WorldLoginInterface;
import net.sf.world.remote.WorldRegistry;
...
public class WorldRegistryImpl extends UnicastRemoteObject implements WorldRegistry {
	...
	public void clearGuilds()		//force a reload of guilds from db
	{
		...
		//reload all the online characters in guilds
		try
		{
